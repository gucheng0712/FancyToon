Shader "VFX/VFXApprenticeShader"
{
    ...
    SubShader
    {
        ...
        // The “Offset -1, -1” tag is to avoid Z-fighting when a face of the object with
        // the shader is in the exact same place as another face.
        Offset -1, -1
        LOD 100
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                #ifdef VERTEX_OFFSET
                // in vertex shader, use tex2Dlod instead of tex2D to sample a texture.
